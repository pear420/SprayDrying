...
% PID controller:
kPs = [2.4333 2.8724 3.4597 4.0800];         %[-]    Proportional Gain
tauIs = [7.3000 9.4329 2.9569 2.0000];       %[min]  Integration time
tauDs = [0.4658 0.4104 0.5225 0.5000];       %[min]  Derivative time            %[-]    Differential Gain
ControllerSaturationMax = +10;              %[-]        
ControllerSaturationMin = -10;              %[-]
...
title('PID-controlled unit - reaction curves'); grid on;
